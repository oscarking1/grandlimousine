...
class Macontable extends Component {
    render() {
        return (
                    ...
                    <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <strong>$105/Per Hour</strong> </td>
                                    <td> <strong>$259/Per Hour</strong> </td>
                                </tr>
                                <tr>
                                    <td valign="middle"> <img loading="lazy" title="Luxury/Space" src={landingcarlimo}></img> </td>
                                    <td colspan="3" valign="middle"> <strong>NEED MORE LUXURY/SPACE FROM ATLANTA to MACON? CALL NOW</strong> </td>
                                </tr>
