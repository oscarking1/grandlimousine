	...
	render(){
		return(
			<div >
				...
				{/* <Tab.Container  defaultActiveKey="1" className="dlab-tabs search-filter">
					  
					
						<ul variant="pills" className="nav nav-tabs">
							<li className="nav-item mb-sm-0 mb-2">
								<Nav.Link eventKey="1" className="nav-link active">
						...
						<Tab.Content>
							...
							<Tab.Pane eventKey="1" className="tab-pane">
							...
							<Tab.Pane eventKey="2" className="tab-pane">
							...
							<Tab.Pane eventKey="3" className="tab-pane">
